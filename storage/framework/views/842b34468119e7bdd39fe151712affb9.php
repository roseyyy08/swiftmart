...
function sendScan(barcode) {
    fetch('<?php echo e(route("checkout.scan")); ?>', {
        method: 'POST',
        headers: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.checkout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\swiftmart\resources\views/checkout/scan-device.blade.php ENDPATH**/ ?>