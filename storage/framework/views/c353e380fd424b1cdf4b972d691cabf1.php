    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content" style="background: var(--card-bg); border: 1px solid var(--card-border); color: var(--text);">
            ...
            <div class="modal-body text-center">
                ...
                <p class="fs-6 fw-bold" style="word-break: break-all;"><?php echo e(url('/admin-scan/' . config('services.kiosk_token'))); ?></p>
...
</script><?php /**PATH C:\laragon\www\swiftmart\resources\views/products/_barcode-scanner-modal.blade.php ENDPATH**/ ?>