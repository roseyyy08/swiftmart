...
(function () {
    ...
    function lookupBarcode(barcode) {
        ...
        .then(data => {
            if (data.found) {
                ...
                document.getElementById('restock-link-create').href = '<?php echo e(route("products.create")); ?>?barcode=' + encodeURIComponent(barcode);
    ...
    document.getElementById('restock-btn-confirm').addEventListener('click', function () {
        ...
        fetch('<?php echo e(route("products.restock-confirm")); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': csrfToken,
...
</script><?php /**PATH C:\laragon\www\swiftmart\resources\views/products/_restock-modal.blade.php ENDPATH**/ ?>