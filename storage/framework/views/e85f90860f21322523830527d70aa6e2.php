        ...
        <div class="col-md-7">
            <div class="card mb-3">
                <div class="card-body text-center">
                    ...
                    <p class="fs-5 fw-bold"><?php echo e(url('/checkout/pair/' . $token)); ?></p>
...
document.getElementById('btn-manual-scan').addEventListener('click', function() {
    ...
    apiPost('<?php echo e(route("checkout.scan")); ?>', { barcode: code })
        .then(data => {
            if (data.success) {
...
document.getElementById('btn-check-member').addEventListener('click', function() {
    ...
    apiPost('<?php echo e(route("checkout.member.check")); ?>', { phone: phone })
        .then(data => {
...
document.getElementById('btn-confirm-payment').addEventListener('click', function() {
    ...
    apiPost('<?php echo e(route("checkout.process")); ?>', { payment_method: method })
        .then(data => {
            if (data.success) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.checkout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\swiftmart\resources\views/checkout/index.blade.php ENDPATH**/ ?>