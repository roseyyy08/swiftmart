...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Dashboard'); ?> - SwiftMart</title>
    ...
    <div class="content-wrapper">
        <div class="topbar">
            ...
            <div class="d-flex align-items-center gap-3">
                <a href="<?php echo e(route('checkout.index')); ?>" target="_blank" class="btn-swift-outline-gold">
...
</html><?php /**PATH C:\laragon\www\swiftmart\resources\views/layouts/app.blade.php ENDPATH**/ ?>