...
<?php $__env->startSection('content'); ?>
    ...
    <h1 class="page-heading mb-4">Tambah Produk</h1>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" value="<?php echo e(old('barcode', request('barcode'))); ?>" class="form-control <?php $__errorArgs = ['barcode'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="barcode" id="barcode">
                        <?php echo $__env->make('products._barcode-scanner-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
...
unset($__errorArgs, $__bag); ?>" name="stock" id="stock">
...
unset($__errorArgs, $__bag); ?>
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="btn-swift-ghost">Batal</a>
        </form>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\swiftmart\resources\views/products/create.blade.php ENDPATH**/ ?>