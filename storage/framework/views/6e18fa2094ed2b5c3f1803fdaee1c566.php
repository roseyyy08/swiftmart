...
<head>
    ...
    <style>
        ...
        .alert-success { background: rgba(52,194,129,.15) !important; border-color: rgba(52,194,129,.3) !important; color: var(--success) !important; }
        .alert-danger { background: rgba(217,119,87,.15) !important; border-color: rgba(217,119,87,.3) !important; color: var(--danger) !important; }
        .alert-secondary { background: rgba(255,255,255,.05) !important; border-color: var(--card-border) !important; color: var(--text-muted) !important; }
        .alert-info { background: rgba(31,122,108,.15) !important; border-color: rgba(31,122,108,.3) !important; color: var(--teal-light) !important; }

        hr { border-color: var(--card-border); opacity: 1; }
        .table { color: var(--text) !important; }
        .table td, .table th { border-color: var(--card-border) !important; }
    </style>
</head>
<body>
